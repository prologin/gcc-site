    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        help_text=(
                            "Ce nom est uniquement utilisé pour l'admin django"
                        ),
                        max_length=260,
                        unique=True,
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text=(
                            "Ce texte, si défini, est affiché lors de"
                            " l'inscription à l'évènement (il peut"
                            " éventuellement contenir des liens)"
                        ),
                        null=True,
                        verbose_name="Notes",
                    ),
                ...
                (
                    ...
                    models.TextField(
                        help_text=(
                            "Si ce champ n'est pas spécifié, la description du"
                            " projet sera utilisée."
                        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text",
                    models.CharField(
                        max_length=1000, verbose_name="Texte de la question"
                    ),
                ),
                (
                    "type",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Une réponse par ligne",
                        max_length=500,
                        null=True,
                ...
                (
                    "order",
                    models.PositiveSmallIntegerField(verbose_name="Ordre"),
                ),
                (
                    "form",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        help_text=(
                            "Le nom public du document qui sera affiché aux"
                            " participants"
                        ),
                        max_length=260,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "answer",
                    models.TextField(max_length=10000, verbose_name="Réponse"),
                ),
                (
                    "application",
                    models.ForeignKey(
