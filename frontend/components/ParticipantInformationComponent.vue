<template>
  <b-container fluid>
    ...
    <b-row>
      <b-col>
        <h3>
          Acceptez-vous le partage de ces informations dans le cadre de
          l'organisation d'un covoiturage ?
        </h3>
      </b-col>
    </b-row>
    <b-row>
      <b-col>
        <b-form-group v-slot="{ ariaDescribedby }">
          <b-form-radio-group
            v-model="carpool_use_contact_info"
            :aria-describedby="ariaDescribedby"
            name="some-radios"
          >
            <b-form-radio value="yes"> Oui </b-form-radio>
    ...
    <div v-if="class_level === ClassTypeEnum.AUTRE">
      ...
      <b-form-input
        v-model="other_class"
        required
        :disabled="class_level !== ClassTypeEnum.AUTRE"
        placeholder="Insérer votre classe ici"
      />
    </div>
  </b-container>
</template>
