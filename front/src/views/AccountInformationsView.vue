  ...
  <b-container class="main-body-style px-0" fluid no-gutters>
    ...
    <div class="mx-5 my-4">
      ...
      <p>Les stages Girls Can Code! sont organisés par l'Association
        ...
        notre <b-link :to="{ name: 'privacy' }">page dédiée</b-link>
      </p>
    </div>
    <b-row class="mx-0 mx-md-5">
      <b-col class="d-none d-md-block col-md-3">
        <div class="sidebar-item">
          <div class="make-me-sticky">
            <b-button class="secondary-button" block @click="scrollTo('personal-info', 'center')">
              <b-icon-person-circle aria-hidden="true" class="mr-3" />
              Informations personnelles
            </b-button>
            <b-button class="secondary-button" block @click="scrollTo('email', 'center')">
              <b-icon-envelope aria-hidden="true" class="mr-3" />
              E-mail
            </b-button>
            <b-button class="secondary-button" block @click="scrollTo('password', 'center')">
              <b-icon-unlock aria-hidden="true" class="mr-3" />
              Mot de passe
            </b-button>
            <b-button class="secondary-button" block @click="scrollTo('notifications', 'center')">
              <b-icon-bell aria-hidden="true" class="mr-3" />
              Gestion des notifications
            </b-button>
            <b-button class="secondary-button" block @click="scrollTo('rgpd', 'center')">
              <b-icon-gear aria-hidden="true" class="mr-3" />
              Archive des données
            </b-button>
            <b-button class="secondary-button" block @click="scrollTo('delete', 'center')">
      ...
      <b-col>
        <b-col md="12" id="personal-info" class="mb-5 p-5 account-group">
          ...
          <h3>Informations traitées seulement en cas de sélection à un stage, d'appel d'urgence, d'envois de courrier ou
            d'email ou lors de la connexion.</h3>
          <b-row class="mt-3">
            <b-col md="6">
              <b-form-group id="input-group-3" label="Nom :" label-for="input-3">
                <b-form-input block id="input-3" v-model="accountInfo.lastName" type="text"
                  placeholder="Entrer votre nom" required />
              </b-form-group>
            </b-col>
            <b-col md="6">
              <b-form-group id="input-group-4" label="Prénom :" label-for="input-4">
                <b-form-input id="input-4" v-model="accountInfo.firstName" type="text" placeholder="Entrer votre prénom"
                  required />
              </b-form-group>
            </b-col>
          </b-row>
          ...
          <b-form-group class="mt-3" id="input-group-5" label="Adresse :" label-for="input-5">
            <b-form-input id="input-5" v-model="accountInfo.address.numberAndRoad" type="text"
              placeholder="Nom et numéro de voie" />
            <b-input-group>
              <b-form-input id="input-6" v-model="accountInfo.address.postalCode" type="text"
                placeholder="Code postal" />
              <b-form-input id="input-7" v-model="accountInfo.address.city" type="text" placeholder="Ville" />
            </b-input-group>
            <b-form-input id="input-8" v-model="accountInfo.address.country" type="text" placeholder="Pays" />
          </b-form-group>
        ...
        <b-col md="12" class="my-5 p-5 account-group" id="email">
          <h1>Changer d'adresse email</h1>
          <b-form-group id="input-group-email" label="E-mail :" label-for="input-current-email">
            <b-form-input id="input-current-email" v-model="email" type="email" placeholder="Entrer votre nouvel email"
              required />
          </b-form-group>
        ...
        <b-col md="12" class="my-5 p-5 account-group" id="password">
          ...
          <b-form-group id="input-group-password-current" label="Mot de passe actuel :"
            label-for="input-current-password">
            <b-form-input id="input-current-password" v-model="oldPassword" type="password"
              placeholder="Entrer votre ancien mot de passe" required />
          </b-form-group>
          <b-form-group id="input-group-password-new" label="Nouveau mot de passe :" label-for="input-new-password">
            <b-form-input id="input-new-password" v-model="newPassword" type="password"
              placeholder="Entrer votre nouveau mot de passe" required />
          </b-form-group>
          <b-form-group id="input-group-password-confirm" label="Confirmer le nouveau mot de passe :"
            label-for="input-confirm-password">
            <b-form-input id="input-confirm-password" v-model="confirmPassword" type="password"
        ...
        <b-col md="12" class="my-5 p-5 account-group" id="notifications">
          ...
          <b-form-group label="Recevoir par email les prochains stages" v-slot="{ ariaDescribedby }">
            <b-form-radio-group id="radio-group-5" v-model="accountInfo.newsletter" :aria-describedby="ariaDescribedby"
              required>
        ...
        <b-col md="12" class="my-5 p-5 account-group" id="rgpd">
          ...
          <h3>Vous pouvez télécharger une archive contenant toutes vos données personnelles, comme prévu par le Droit à
            la portabilité (Art. 20 du RGPD).</h3>
          <b-col offset-md="8" class="mt-5 p-0 col-12 col-md-4">
        ...
        <b-col md="12" class="my-5 p-5 account-group" id="delete">
          ...
          <h3>Vous pouvez supprimer votre compte et toutes les données personnelles associées, comme prévu par votre
            Droit à la suppression (Art. 17 du RGPD).</h3>
          <b-col offset-md="8" class="mt-5 p-0 col-12 col-md-4">
