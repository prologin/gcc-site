...
AWS_S3_MEDIA_CUSTOM_DOMAIN = env.get_string("DJANGO_S3_MEDIA_CUSTOM_DOMAIN", AWS_S3_CUSTOM_DOMAIN)
AWS_S3_STATIC_CUSTOM_DOMAIN = env.get_string("DJANGO_S3_STATIC_CUSTOM_DOMAIN", AWS_S3_CUSTOM_DOMAIN)
